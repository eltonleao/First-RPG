...
var dialogue_line: DialogueLine:
	set(next_dialogue_line):
		...
		character_portrait.texture = load("res://characters/%s%s.png" % [dialogue_line.character.to_lower(), file_suffix])
...
func _on_mutated(_mutation: Dictionary) -> void:
	is_waiting_for_input = false
	balloon.hide()
	Game.is_dialogue_playing = false
